...
// node_modules/@lexical/react/LexicalDraggableBlockPlugin.dev.mjs
...
function getBlockElement(anchorElem, editor, event, useEdgeAsDefault = false) {
  ...
  editor.getEditorState().read(() => {
    if (useEdgeAsDefault) {
      ...
      const [firstNodeRect, lastNodeRect] = [firstNode != null ? firstNode.getBoundingClientRect() : void 0, lastNode != null ? lastNode.getBoundingClientRect() : void 0];
...
function useDraggableBlockMenu(editor, anchorElem, menuRef, targetLineRef, isEditable, menuComponent, targetLineComponent, isOnMenu) {
  ...
  const isDraggingBlockRef = (0, import_react.useRef)(false);
  const [draggableBlockElem, setDraggableBlockElem] = (0, import_react.useState)(null);
  ...
  return (0, import_react_dom.createPortal)((0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
...
//# sourceMappingURL=@lexical_react_LexicalDraggableBlockPlugin.js.map
