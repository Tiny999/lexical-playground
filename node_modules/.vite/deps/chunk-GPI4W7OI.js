...
var baseExcludedProperties = /* @__PURE__ */ new Set(["__key", "__parent", "__next", "__prev"]);
var elementExcludedProperties = /* @__PURE__ */ new Set(["__first", "__last", "__size"]);
var rootExcludedProperties = /* @__PURE__ */ new Set(["__cachedText"]);
...
function $getOrInitCollabNodeFromSharedType(binding, sharedType, parent) {
  ...
  if (collabNode === void 0) {
    ...
    } else if (sharedType instanceof YXmlElement) {
...
function syncPropertiesFromYjs(binding, sharedType, lexicalNode, keysChanged) {
  const properties = keysChanged === null ? sharedType instanceof YMap ? Array.from(sharedType.keys()) : Object.keys(sharedType.getAttributes()) : Array.from(keysChanged);
  let writableNode;
...
function syncPropertiesFromLexical(binding, sharedType, prevLexicalNode, nextLexicalNode) {
  ...
  for (let i = 0; i < properties.length; i++) {
    ...
    const prevValue = (
      ...
      prevLexicalNode === null ? void 0 : prevLexicalNode[property]
    );
...
var CollabElementNode = class _CollabElementNode {
    ...
    for (let i = 0; i < deltas.length; i++) {
      ...
      if (delta.retain != null) {
        ...
        while (deletionSize > 0) {
          ...
          if (node instanceof _CollabElementNode || node instanceof CollabLineBreakNode || node instanceof CollabDecoratorNode) {
    ...
    for (let i = 0; i < collabChildrenLength; i++) {
      ...
      if (collabLexicalChildNode !== null && lexicalChildKey === collabKey) {
        ...
        if (childNeedsUpdating) {
          ...
          if (childCollabNode instanceof _CollabElementNode) {
        ...
        if (collabKeys === void 0) {
          ...
          for (let s = 0; s < collabChildrenLength; s++) {
            ...
            const childKey2 = child._key;
            if (childKey2 !== "") {
              collabKeys.add(childKey2);
            }
          }
        }
  ...
  _syncChildFromLexical(binding, index, key, prevNodeMap, dirtyElements, dirtyLeaves) {
    ...
    if (childCollabNode instanceof _CollabElementNode && $isElementNode(nextChildNode)) {
  ...
  append(collabNode) {
    ...
    if (collabNode instanceof _CollabElementNode) {
...
function createBinding(editor, provider, id, doc, docMap, excludedProperties) {
  ...
  const rootXmlText = doc.get("root", YXmlText);
...
var CONNECTED_COMMAND = createCommand("CONNECTED_COMMAND");
var TOGGLE_CONNECT_COMMAND = createCommand("TOGGLE_CONNECT_COMMAND");
...
//# sourceMappingURL=chunk-GPI4W7OI.js.map
