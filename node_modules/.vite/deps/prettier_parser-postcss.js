  ...
  "node_modules/prettier/parser-postcss.js"(exports, module) {
    (function(e) {
      ...
      var Ur = U((Kp, Yn) => {
        ...
        })("versions", []).push({ version: "3.26.1", mode: ou ? "pure" : "global", copyright: "© 2014-2022 Denis Pushkarev (zloirock.ru)", license: "https://github.com/zloirock/core-js/blob/v3.26.1/LICENSE", source: "https://github.com/zloirock/core-js" });
      });
      var Zn = U((Qp, Xn) => {
        var au = Ir(), uu = Object;
...
`), ee = z.length - 1, ee > 0 ? (le = E + ee, re = T - z[ee].length) : (le = E, re = G), J.push(["comment", te, E, S - G, le, T - re, S]), G = re, E = le, S = T;
          ...
          A();
          function i(h, l) {
            for (var p = 1, m = h.length, c = h[0], t = h[0], r = 1; r < m; ++r) if (t = c, c = h[r], l(c, t)) {
              if (r === p) {
                p++;
                continue;
              }
          ...
          function u(h) {
            for (var l = 1, p = h.length, m = h[0], c = h[0], t = 1; t < p; ++t, c = m) if (c = m, m = h[t], m !== c) {
              if (t === l) {
                l++;
                continue;
              }
          ...
          var f = function() {
            ...
            return y.warnings = function() {
              ...
              try {
                ...
                else if (_.postcssVersion && false) var k, x, N, I, W;
              } catch ($) {
        ...
        function ga(e, n) {
          if (e && typeof e == "object") {
            ...
            if (l.length > 0) {
              ...
              let c = l.match(vp);
              if (c && (l = l.slice(0, c.index), e.scssGlobal = true, c[0].trim() !== "!global" && (e.raws.scssGlobal = c[0])), l.startsWith("progid:")) return { type: "value-unknown", value: l };
              e.value = Pe(l, n);
            }
...
export default require_parser_postcss();
